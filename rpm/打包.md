...
version=0.1
release=3
echo RPM信息;rpm -qpi ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.el8.x86_64.rpm
echo 配置文件;rpm -qpc ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.el8.x86_64.rpm
echo 所有文件;rpm -qpl ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.el8.x86_64.rpm
