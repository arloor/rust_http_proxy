...
version=0.1
release=3
echo RPM信息;rpm -qpi ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.all.x86_64.rpm
echo 配置文件;rpm -qpc ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.all.x86_64.rpm
echo 所有文件;rpm -qpl ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.all.x86_64.rpm
...
yum install -y ~/rpmbuild/RPMS/x86_64/rust_http_proxy-${version}-${release}.all.x86_64.rpm
## 启动
