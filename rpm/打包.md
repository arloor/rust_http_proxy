...
```shell
rpm -ivh ~/rpmbuild/RPMS/x86_64/rust_http_proxy-0.1-1.el9.x86_64.rpm #rpm包在此
```
...
rpm -ivh ~/rpmbuild/RPMS/x86_64/rust_http_proxy-0.1-1.el9.x86_64.rpm
service rust_http_proxy start;service rust_http_proxy status --no-page
