...
version=0.1
release=1.all
wget https://github.com/arloor/rust_http_proxy/releases/download/v0.5.0/rust_http_proxy-"${version}"-"${release}".x86_64.rpm -O rust_http_proxy-"${version}"-"${release}".x86_64.rpm
...
```shell
wget https://github.com/arloor/rust_http_proxy/releases/download/v0.5.0/rust_http_proxy -O /tmp/rust_http_proxy.bin
