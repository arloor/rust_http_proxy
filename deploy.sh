...
ssh root@hk.arloor.dev "cp /root/rpmbuild/RPMS/x86_64/rust_http_proxy-0.1-1.all.x86_64.rpm /usr/share/nginx/html/rust_http_proxy-0.1-1.all.x86_64.rpm"
...
for i in li.arloor.dev ti.arloor.com sg.arloor.dev dc6.arloor.dev dc9.arloor.dev bwg.arloor.dev; do
  ssh root@${i} "
